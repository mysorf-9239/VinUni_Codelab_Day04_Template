...
# Định nghĩa JSON Schema cho từng tool (name, description, parameters).
# ---------------------------------------------------------------------------
...
TOOL_DEFINITIONS = [
    {
        ...
        "parameters": {
            ...
            "properties": {
                "category": {
                    "type": "string",
                    "description": "Danh mục: 'xe_dien' cho xe VinFast, 'du_lich' cho dịch vụ Vinpearl.",
                    "enum": ["xe_dien", "du_lich"]
                },
                "max_price": {
                    "type": "integer",
                    "description": "Giá tối đa tính bằng VNĐ. Bỏ qua nếu không giới hạn ngân sách."
                }
            },
            "required": ["category"]
        }
    },
    {
        ...
        "description": "Tạo và lưu ticket hỗ trợ cho vấn đề hoặc phản hồi của khách hàng Vingroup.",
        "parameters": {
            "type": "object",
            "properties": {
                "customer_name": {
                    "type": "string",
                    "description": "Tên khách hàng gửi yêu cầu hỗ trợ."
                },
                "issue_description": {
                    "type": "string",
                    "description": "Mô tả vấn đề hoặc phản hồi cần xử lý."
                },
                "priority": {
                    "type": "string",
                    "description": "Mức ưu tiên: low (thấp), medium (trung bình), high (cao/khẩn cấp).",
